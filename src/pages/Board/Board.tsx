...
const Board: React.FC = () => {
  const [boards, setBoards] = useState<HTMLDivElement[]>([]);
    ...
    useEffect(() => {
        ...
        const slidesArray = Array.from(document.querySelectorAll('.board')) as HTMLDivElement[];
        setBoards(slidesArray);
    }, []);

    // useCallback to memoize changeSlide
    const changeBoard = useCallback((index: number) => {
  ...
  return (
    <div className="relative w-screen h-[29.0625rem] mt-10 ">
            <div className=" boards absolute w-screen h-full
                ...
                <div className="board visible">
                    ...
                    >
                        HLV trưởng <br /> đội tuyển OLP THSV <br /> trường ĐH GTVT <br /> GV
                        bộ môn KHMT
                    </p>
                    </div>
                    <div className="w-80 h-fit">
            ...
            {/* Button */}
            <button onClick={prevButton}  type="button" className="absolute left-32 top-1/2 ">
                <svg
            ...
            <button onClick={nextButton} type="button" className="absolute right-32 top-1/2 ">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="46"
                height="46"
