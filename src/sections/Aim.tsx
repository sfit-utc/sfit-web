...
function Aim() {
    return (
        <div id="aim" className="relative bg-white w-screen h-screen overflow-x-hidden">
            {/* Header */}
            <div
            className="flex justify-center items-center flex-col      
                            [&>div]:w-[40rem] [&>div]:h-[20rem]
                            [&>div]:shadow-[0px_4px_27px_0px_#0F3122] 
                            [&>div]:bg-cover [&>div]:bg-no-repeat [&>div]:bg-center
                            *:font-[playfair-display]"
            >
            <h1 className=" mx-24 mt-24 mb-12 italic text-[2.125rem] font-bold text-[#194C35] tracking-[1.36px]">
                "Đoàn kết - Sáng tạo - Phát triển"
            </h1>
            <div className="slide bg-[url(./assets/CLB.jpg)]"></div>
            </div>
            {/* Para */}
            <div
            className="*:font-[playfair-display] 
                            [&>p]:mx-40 [&>p]:text-center [&>p]:tracking-wider [&>p]:font-medium [&>p]:text-xl [&>p]:text-black
                            mt-14 [&>p]:w-fit"
            >
            <p className="">
                SFIT được thành lập vào năm 2016 - là CLB trực thuộc và lớn mạnh của
                khoa CNTT Trường đại học Giao thông Vận tải. Đây còn là mái nhà
                chung của những sinh viên có niềm đam mê lập trình, đến từ nhiều
                ngành học như: Công nghệ thông tin, Điện - điện tử, Toán ứng dụng…{" "}
            </p>
            <p className="">
                CLB có nhiều cuộc thi, hoạt động và trải nghiệm thú vị, tạo môi
                trường năng động, rèn luyện cho các thành viên từ những kỹ năng,
                kiến thức chuyên môn cũng như những kỹ năng mềm giúp các thành viên
                có nhiều trải nghiệm hơn để hoàn thiện bản thân trong các lĩnh vực,
                cũng như hoàn thiện mảnh ghép thanh xuân mà sinh viên nào cũng nên
                có.
            </p>
            </div>
